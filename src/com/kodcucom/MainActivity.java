...
public class MainActivity extends Activity {
	...
	public static String URL = "http://192.168.1.136/isim.php?ogrenci_adi=";//Bilgisayarın IP adresi
	...
	public void parseJson(JSONObject ogrenciJson) {
		...
		try {
			ogrenci_ad_tv.setText("Öğrenci Adı :"+ ogrenciJson.getString("ogrenci_adi"));
			ogrenci_numara_tv.setText("Numara :"+ ogrenciJson.getInt("ogrenci_numara"));
